...
\begin{enumerate}[label=(\roman*)]
  \item \textbf{Neue Primzahlen (Rayleigh-Quotient-Argument).}
    ...
    Durch eine Standard-Rayleigh-Quotient-Störungsschranke (s.\ z.B.\ \cite{Kato1995}, Satz~V.4.10) ist damit der führende Eigenvektor des geraden Blocks stabil unter dem Rang-Eins-Update, sodass der gerade Grundzustandseigenwert \emph{stärker} fällt als der ungerade.
