...
\begin{enumerate}[label=(\roman*)]
  \item \textbf{New primes (Rayleigh-quotient argument).}
    ...
    By a standard Rayleigh-quotient perturbation bound (see, e.g., \cite{Kato1995}, Theorem~V.4.10), this ensures that the leading eigenvector of the even block is stable under the rank-one update, so the even-sector ground-state eigenvalue drops \emph{more} than the odd-sector ground-state eigenvalue.
